...
<body>
    ...
    <div class="upper-nav primary-bg p-2 px-3 text-center text-break">
        <span>Promo Terbatas Gajian Sale - Diskon 50%! <a>Shop Now</a></span>
    </div>
    <!-- upper-nav -->
    <!-- Start NavBar -->
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand fw-bold" href="#">Wira Karya Teknik</a>
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="d-block" src="assets/images/logo22.jpg" alt="First slide" width="100%" height="615px">
        ...
        <div class="carousel-item">
            <img class="d-block" src="assets/images/logo22.jpg" alt="Second slide" width="100%" height="615px">
            <div class="carousel-caption">
                <!-- <h3>New York</h3>
        ...
        <div class="carousel-item">
            <img class="d-block" src="assets/images/logo22.jpg" alt="Third slide" width="100%" height="615px">
            <div class="carousel-caption">
                <!-- <h3>New York</h3>
                    <p>We love the Big Apple!</p> -->
            </div>
