    ...
    <div class="landing">
        <div class="container">
            <div class="row py-5 m-0">
                ...
                <!-- function to update quantities and remove items  -->
                <?php
                    ...
                    if (isset($_POST['update_cart'])) {
                        foreach ($_POST as $key => $value) {
                            if (strpos($key, 'qty_') === 0) {
                                ...
                                $quantity = $value;
                                $update_query = "UPDATE `card_details` SET quantity=$quantity WHERE product_id=$product_id";
