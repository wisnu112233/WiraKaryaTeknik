...
function getProduct($numToDisplay = '') {
    global $con; // Ensure $con is accessible within this function
...
function cart($num_of_items = 1) {
    ...
    if (isset($_GET['add_to_cart'])) {
        ...
        if ($num_of_rows > 0) {
            ...
            $insert_query = "INSERT INTO `card_details` (product_id, ip_address, quantity) VALUES ($getProductId, '$getIpAddress', $num_of_items)";
